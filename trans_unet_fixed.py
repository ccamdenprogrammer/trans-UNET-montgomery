# -*- coding: utf-8 -*-
"""trans-UNET-fixed.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1NrK9GDp8iUdz-lLFY_t7O3aq_fxJWXsq
"""
...
# Dataset paths
DATASET_PATH = "/content/drive/My Drive/Datasets/montgomery_data"
CXR_PATH = os.path.join(DATASET_PATH, "CXR_png")
LEFT_MASK_PATH = os.path.join(DATASET_PATH, "ManualMask/leftMask")
RIGHT_MASK_PATH = os.path.join(DATASET_PATH, "ManualMask/rightMask")
...
# Transformer Layer (Self-Attention) Definition
def transformer_block(inputs, num_heads, num_filters):
    """Transformer block with Multi-Head Self-Attention."""
    # Multi-Head Self-Attention
    attention = tf.keras.layers.MultiHeadAttention(num_heads=num_heads, key_dim=num_filters)(inputs, inputs)
    x = tf.keras.layers.Add()([inputs, attention])
    x = tf.keras.layers.LayerNormalization()(x)

    # Feed-forward network (MLP)
    x = tf.keras.layers.Conv2D(num_filters, 1, activation="relu")(x)
...
# Building the corrected TransUNet model
def build_transunet(input_shape):
    """Build corrected TransUNet model with transformer block."""
    ...
    # Transformer bridge
    b1 = transformer_block(p4, num_heads=8, num_filters=512)
